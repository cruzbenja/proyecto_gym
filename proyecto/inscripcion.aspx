<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inscripcion.aspx.cs" Inherits="proyecto.inscripcion" %>
            ...
            <div class="row mb-2">
              ...
              <div class="col-12 col-md-3 text-right">
                 <%-- <asp:Button ID="Button1" type="button" class="btn btn-primary btn-block" runat="server" Text="Nuevo Cliente" OnClick="Button1_Click" />--%>
                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalRegistrarCliente"><i class="fas fa-plus-circle"></i> Nueva Inscripción</button>                   
              </div>     
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
        </div>
              ...
              <div class="card-body">
                   ...
                   <div id="contenerdor_tabla" class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-striped" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="idInscripcion" HeaderText="#" />
                            ...
                            <asp:BoundField DataField="costo" HeaderText="Mensualidad" ApplyFormatInEditMode="True" />
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <br>
                        <label for="inputName" class="form-label"><b>Metodo de Pago</b></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                    ...
                    <div class="col-md-6">
                    <br>
                        <label for="inputName" class="form-label"><b>Fecha Inscripción</b></label>
                        <div class="input-group">                 
                             <asp:TextBox type="date" class="form-control shadow-lg" ID ="fechaIng" runat="server"></asp:TextBox>
