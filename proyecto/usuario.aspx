...
<body class="hold-transition sidebar-mini layout-fixed sidebar-closed sidebar-collapse">
   ...
   <div class="content-wrapper">
            ...
            <div class="row mb-2">
              ...
              <div class="col-12 col-md-3 text-right">
                 <%-- <asp:Button ID="Button1" type="button" class="btn btn-primary btn-block" runat="server" Text="Nuevo Cliente" OnClick="Button1_Click" />--%>
                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalRegistrarCliente"><i class="fas fa-plus-circle"></i> Nuevo Usuario</button>                   
              </div>     
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="inputCasa" class="form-label"><b>Nombre Empleado</b></label>
              ...
              <div class="card-body">
                   ...
                   <div id="contenerdor_tabla" class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="id_usu" HeaderText="#" />
                            <asp:BoundField DataField="nombre" HeaderText="Empleado" />
                            <asp:BoundField DataField="usuario" HeaderText="Usuario" />
                            <asp:BoundField DataField="rol" HeaderText="Rol" />
                             <asp:TemplateField HeaderText="Acción">
                                <ItemTemplate>
                                    <%--<asp:Button ID="Button1" runat="server" type="button" class="btn btn-primary" Text="Permisos" OnClick="Button1_Click" />--%>
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#ModalPermisosEmpleado">Modificar Rol</button>
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#ModalEliminarEmpleado"><i title="Eliminar Usuario" class="fas fa-trash">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">                  
                        <label for="inputName" class="form-label"><b>Nombre Empleado</b></label>
                    ...
                    <div class="col-md-6">
                      <br>
                        <label for="inputName" class="form-label"><b>Usuario</b></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                            </div>
                             <asp:TextBox type="text" class="form-control shadow-lg" ID ="user" placeholder="Ingresar usuario" runat="server"></asp:TextBox>                                                  
                        </div>                 
                    </div>               
                    <div class="col-md-6">
                    <br>
                        <label for="inputName" class="form-label"><b>Contraseña</b></label>
                        <div class="input-group">   
                             <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-key"></i></span>
                            </div>              
                             <asp:TextBox type="text" class="form-control shadow-lg" ID ="contra" placeholder="Ingresar contraseña" runat="server" TextMode="Password"></asp:TextBox>                                           
                        </div>                 
                    </div>
                    <br />         
                    <div class="col-md-6">                  
                        <label for="inputName" class="form-label"><b>Roles</b></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-user-cog"></i></span>
                            </div>
                             <asp:DropDownList ID="DropDownList3" class="form-control shadow-lg" runat="server">
    ...
    <div class="modal fade" id="ModalPermisosEmpleado">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
               <div class="row">
                    <div class="col-md-12">
                        ...
                        <label for="inputName" class="form-label"><b>Nombre Rol</b></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-user-tag"></i></span>
                            </div>
                             <asp:DropDownList ID="DropDownList1" class="form-control shadow-lg" runat="server">
            ...
            <div class="modal-footer col-md-12">            
                <asp:Button ID="Button2" runat="server"  class="btn btn-primary" Text="Actualizar" OnClick="Button2_Click" />
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>            
            </div>
          </div>
          <!-- /.modal-content -->
        ...
        <!-- /.modal-dialog -->
         ...
         <script type="text/javascript">
             ...
             function openmodal() {
                 $("#ModalPermisosEmpleado").modal("show");
             }
    </script>
    </form>
