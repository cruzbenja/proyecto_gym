<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="empleado.aspx.cs" Inherits="proyecto.empleado" %>
...
<body class="hold-transition sidebar-mini layout-fixed sidebar-closed sidebar-collapse">
   ...
   <div class="content-wrapper">
    <!-- Content Header (Page header) -->
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-9">
                <h1 class="m-0">Empleados
                    
                  </h1>
              </div>
              <div class="col-12 col-md-3 text-right">
              
                              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalRegistrarEmpleado"><i class="fas fa-plus-circle"></i> Nuevo Empleado</button>                              
                          </div>  
                                            ...
                                            <div class="form-horizontal">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                     ...
                                                     <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="inputCasa" class="form-label"><b>Carnet</b></label>
                                                            <asp:TextBox type="text" class="form-control" ID ="txtCarnetFil" placeholder="Ingresar carnet" runat="server"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
              ...
              <div class="card-body">
                  ...
                  <br />
                   <div id="contenerdor_tabla" class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-striped" AutoGenerateColumns="False" AllowSorting="True">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ci" HeaderText="Carnet" />
                            <asp:BoundField DataField="fechanac" HeaderText="Fecha Nacimiento" ApplyFormatInEditMode="True" />
                            <asp:BoundField DataField="fechaing" HeaderText="Fecha Ingreso" />
                            <asp:BoundField DataField="sueldo" HeaderText="Sueldo" />
                            <asp:TemplateField HeaderText="Acción">
                                <ItemTemplate>
                                    <asp:Button ID="Button1" runat="server" type="button" class="btn btn-primary" OnClick="Button1_Click" Text="Editar" />
    ...
    <div class="modal fade" id="ModalRegistrarEmpleado" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="tituloJugador"><i class="nav-icon fas fa-user-plus"></i> Nuevo Empleado</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <label for="inputName" class="form-label"><b>Nombre Completo</b></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                            </div>
                             <asp:TextBox type="text" class="form-control" ID ="nombre" placeholder="Ingresar nombre completo" runat="server"></asp:TextBox>
                            <%--<input type="text" class="form-control" id ="nombre" placeholder="Ingresar ombre completo" /> --%>                         
                        </div>                 
                    </div>       
                    <div class="col-md-12">
                      <br>
                        <label for="inputName" class="form-label"><b>Direccion</b></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-road"></i></span>
                            </div>
                            <asp:TextBox type="text" class="form-control" ID ="direccion" placeholder="Ingresar dirección" runat="server"></asp:TextBox>
                            <%--<input type="text" class="form-control" id ="paterno" placeholder="Ingresar dirección" />--%>                          
                        </div>                 
                    </div>   
                    <div class="col-md-6">
                      <br>
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-text"><i class="fas fa-phone"></i></span>
                             ...
                             <asp:TextBox type="text" class="form-control" ID ="telefono" placeholder="Ingresar telefono" runat="server"></asp:TextBox>
                    ...
                    <div class="col-md-6">
                      <br>
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-text"><i class="fas fa-address-card"></i></span>
                             ...
                             <asp:TextBox type="text" class="form-control" ID ="ci" placeholder="Ingresar carnet" runat="server"></asp:TextBox>
                     ...
                     <div class="col-md-6">
                      <br>
                        <label for="inputName" class="form-label"><b>Sueldo</b></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                            </div>
                             <asp:TextBox type="text" class="form-control" ID ="sueldo" placeholder="Ingresar telefono" runat="server"></asp:TextBox>
                    ...
                    <br>
                        ...
                        <div class="input-group">                 
                             <asp:TextBox type="date" class="form-control" ID ="fechaNac" runat="server"></asp:TextBox>
                                              
                        </div>                 
                    </div>
                     <div class="col-md-6">
                    <br>
                        <label for="inputName" class="form-label"><b>Fecha Ingreso</b></label>
                        <div class="input-group">   
                              <asp:TextBox type="date" class="form-control" ID ="fechaIng" runat="server"></asp:TextBox>              
    ...
    <div class="modal fade" id="ModalEliminarEmpleado" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <label for="inputName" class="form-label">¿Seguro que desea eliminar al empleado?</label>          
                    </div>       
            ...
            <div class="modal-footer col-md-12">            
                <asp:Button ID="Button3" runat="server"  class="btn btn-primary" Text="Eliminar" OnClick="btnGuardar_Click" />
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>            
            </div>
          </div>
          <!-- /.modal-content -->
