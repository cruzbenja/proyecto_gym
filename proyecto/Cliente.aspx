<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="proyecto.Cliente" %>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"><i class="nav-icon fas fa-user-plus"></i> Nuevo Cliente</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <label for="inputName" class="form-label">¿Seguro que desea eliminar al cliente?</label>          
                    </div>       
